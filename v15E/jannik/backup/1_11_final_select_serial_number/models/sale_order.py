                    ...
                    if order_line_id and order_line_id.stock_lot_id:
                        ...
                        # check_lot_id =
                            print("\n\n\n order_line_id.stock_lot_id.id##########",
                                  order_line_id.stock_lot_id.id, order_line_id.tax_id)
                            # lot_list.append(order_line_id.lot_id.id)
                            print("\n\n\n\n MOve:::::::::::::::::::::::::::::::::::::::MOVEeee taxxxx code beforeeeeeeeeeeeeeeeeee", move, move.tax_code)
                            ...
                            print("\n\n\n\n MOve:::::::::::::::::::::::::::::::::::::::MOVEeee taxxxx code afterrrrrrrrrrrrrrrrrrrrr", move, move.tax_code)
                            print("\n\n\n move:::::::::::::::::afterrrrrrrrrrrrrrr:::::::::::::",
                                  move, move.product_id, move.lot_id, move.tax_code)
        return res
